...
<body>
    ...
    <form id="form1" runat="server">
            ...
            <div>
                ...
                <asp:Button ID ="btnSaludar" Text="Saludar" runat="server" OnClick="btnSaludar_Click" ValidationGroup="1" />
            </div>
            <div>
                <asp:Label Text="Escriba su edad" runat="server" />
                <br />
                <asp:TextBox ID="txtEdad" runat="server" CssClass="txt"></asp:TextBox>
                <asp:RangeValidator ID="rvEdad" runat="server" ErrorMessage="Solo se valida edades de 15-30" MaximumValue="30" MinimumValue="15" ControlToValidate="txtEdad" Font-Bold="True" Font-Italic="True" ForeColor="Lime" Type="Integer" ValidationGroup="1">*</asp:RangeValidator>
